...
<!-- affichage de toutes les reunions -->
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>Archives des réunions</h4>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    if(mysqli_num_rows($dem_reun) > 0)
                                    {
                                        ...
                                        {
                                            if($item['reun_isApproved'] == '3' || $item['reun_isApproved'] == '-3')
                                            {
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-wrap"><?= $nomSalle ?> <?= $numSalle ?></td> 
                                                        <td><?= ($item['reun_isApproved'] == '3')? 'Approuvee' : 'Rejetee' ?></td>
                                                    </tr>
                                                <?php
                                            }
                                        }
